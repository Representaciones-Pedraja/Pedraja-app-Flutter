                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${order.totalPaid.toStringAsFixed(2)} EUR',
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: AppTheme.accentBlue,
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(),
                  const SizedBox(height: 16),
                  _buildDetailRow('Subtotal', '${order.totalProducts.toStringAsFixed(2)} EUR'),
                  _buildDetailRow('Shipping', '${order.totalShipping.toStringAsFixed(2)} EUR'),
                  if (order.totalDiscount > 0)
                    _buildDetailRow('Discount', '-${order.totalDiscount.toStringAsFixed(2)} EUR'),
                  const SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
